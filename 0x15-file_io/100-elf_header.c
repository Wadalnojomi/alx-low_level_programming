...
/**
 * print_data - Prints data of EFL header.
 * @e_ident: A pointer containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_version - Prints version of EFL header.
 ...
 * @e_ident: pointer containing the ELF OS/ABI.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
...
/**
 * print_abi - Prints ABI version EFL header
 ...
 * Return: 0 on success.
 *
 * Description: exit code 98-if file isn't an ELF File or function fails.
 */
